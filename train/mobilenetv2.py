...
print("Preloading sketches into RAM for zero-disk-latency training...")
...
# --- define transfer learning model (MobileNetV2) and fine-tuning ---
...
epochs = 60
min_epochs = 10
model_save_path = os.path.join(MODELS_DIR, "mobilenet_v2_tuberlin.pth")
early_stopping = EarlyStopping(patience=6, min_delta=1e-3, checkpoint_path=model_save_path, min_epochs=min_epochs)

# --- training and validation loop ---
if __name__ == '__main__':
    print(f"\nTraining MobileNetV2 on device: {device} (AMP Mixed Precision: {device.type == 'cuda'})")
